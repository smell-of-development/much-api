...
# alter table if exists tb_project_join
#     add constraint tb_project_join_fk2 foreign key (position_id) references tb_project_position;

alter table if exists tb_project_join
    add constraint tb_project_join_fk3 foreign key (member_id) references tb_user;
...
# alter table if exists tb_project_application
#     add constraint tb_project_application_fk2 foreign key (position_id) references tb_project_position;

alter table if exists tb_project_application
    add constraint tb_project_application_fk3 foreign key (member_id) references tb_user;
