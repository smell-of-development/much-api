...
alter table if exists tb_study_join
    add constraint tb_study_join_fk1 foreign key (study_id) references tb_study;

alter table if exists tb_study_application
    add constraint tb_study_application_fk1 foreign key (study_id) references tb_study;
